<script>
  let font_color = "oklch(var(--l6-t) var(--c8) var(--primary-h))"
  let part_2 = "oklch(var(--l8) var(--c10) var(--h18))"
</script>

<div class="container" style="--font_color: {font_color};">
  <div class="logo">
    <svg
...
<style>
  ...
  .logo_text {
    ...
    line-height: clamp(1.6rem, 5vw, 2.2rem);
  }
</style>
